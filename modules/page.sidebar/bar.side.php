...
if ($_SESSION["role"] == null || $_SESSION["role"] == "" || $_SESSION["role"] == "guest") {
    $_SESSION["role"] == "gst";
}

?>

<aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 rounded-1" id="sidenav-main">
    <div class="sidenav-header">
        <i class="fas fa-times p-3 cursor-pointer text-secondary opacity-5 position-absolute end-0 top-0 d-none d-xl-none" aria-hidden="true" id="iconSidenav"></i>
        <a class="navbar-brand m-0" href="/dashboard/" target="_blank">
            <img src="/dashboard/DCIM/site/logo_square.png" class="navbar-brand-img h-100" alt="main_logo">
            <span class="ms-1 font-weight-bold">BME.KIRI EV</span>
        </a>
    </div>
    ...
    <div class="collapse navbar-collapse  w-auto h-auto" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <!---------------------------- OVER VIEW SUPER MENU ---------------------------->
            <?php
            if (isset($_SESSION["role"]) && $_SESSION["role"] != "" && $_SESSION["role"] != "null" && $_SESSION["role"] != null) {

                switch ($_SESSION["role"]) {
                    case $_SESSION["role"] == "sadm":
                    case $_SESSION["role"] == "agnt":
                    case $_SESSION["role"] == "chrg":
                    case $_SESSION["role"] == "dist":
                    case $_SESSION["role"] == "fint":
                    case $_SESSION["role"] == "clnt":
                    case $_SESSION["role"] == "gst":
            ?>
                        <li class="nav-item">
            ...
            ?>
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="/dashboard/profile institution.php">
                                <div class="icon icon-shape icon-sm text-center  me-2 d-flex align-items-center justify-content-center">
                                    <i class="fa fa-building text-dark text-sm"></i>
                                </div>
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="/dashboard/profile personal.php">
                                <div class="icon icon-shape icon-sm text-center  me-2 d-flex align-items-center justify-content-center">
                                    <i class="fa-regular fa-id-badge text-dark text-sm"></i>
                                </div>
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="/dashboard/profiles users.php">
                                <div class="icon icon-shape icon-sm text-center  me-2 d-flex align-items-center justify-content-center">
                                    <i class="fa-sharp fa-solid fa-users text-dark text-sm"></i>
                                </div>
            ...
            ?>
                        <li class="nav-item">
                            <hr class="horizontal dark" />
                            <h6 class="ps-4  ms-2 text-uppercase text-xs font-weight-bolder opacity-6">MARKETPLACE</h6>
                        </li>
                        ...
                        ?>
                                <li class="nav-item">
                                    <a class="nav-link" href="/dashboard/onboarding.php">
                                        <div class="icon icon-shape icon-sm text-center  me-2 d-flex align-items-center justify-content-center">
                                            <i class="fa fa-shop text-dark text-sm"></i>
                                        </div>
                        ...
                        ?>
                                <li class="nav-item">
                                    <a class="nav-link" href="/dashboard/performance.php">
                                        <div class="icon icon-shape icon-sm text-center  me-2 d-flex align-items-center justify-content-center">
                                            <i class="fa fa-shop text-dark text-sm"></i>
                                        </div>
                        ...
                        ?>
                                <li class="nav-item">
                                    <a class="nav-link" href="/dashboard/clients.php">
                                        <div class="icon icon-shape icon-sm text-center  me-2 d-flex align-items-center justify-content-center">
                                            <i class="fa fa-shop text-dark text-sm"></i>
                                        </div>
                                        <span class="nav-link-text ms-1">Our Clients</span>
                                    </a>
                                </li>
                        <?php
                                break;
            ...
            <?php if (isset($_SESSION["role"]) && $_SESSION["role"] != "" && $_SESSION["role"] != "null" && $_SESSION["role"] != null) {
            ...
            ?>
                        <li class="nav-item">
                            <hr class="horizontal dark" />
                            <h6 class="ps-4  ms-2 text-uppercase text-xs font-weight-bolder opacity-6">ASSETS</h6>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link" href="">
                                <div class="icon icon-shape icon-sm text-center  me-2 d-flex align-items-center justify-content-center">
                                    <i class="fa-sharp fa-solid fa-car-battery text-dark text-sm"></i>
                                </div>
                                <span class="nav-link-text ms-1">Assets Overview</span>
                            </a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link" href="/dashboard/batteries.php">
                                <div class="icon icon-shape icon-sm text-center  me-2 d-flex align-items-center justify-content-center">
                                    <i class="fa-sharp fa-solid fa-car-battery text-dark text-sm"></i>
                                </div>
                                <span class="nav-link-text ms-1">Batteries</span>
                            </a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link" href="/dashboard/chargers.php">
                                <div class="icon icon-shape icon-sm text-center  me-2 d-flex align-items-center justify-content-center">
                                    <i class="fa fa-bolt text-dark text-sm"></i>
                                </div>
                                <span class="nav-link-text ms-1">Chargers</span>
                            </a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link" href="/dashboard/swap.stations.php">
                                <div class="icon icon-shape icon-sm text-center  me-2 d-flex align-items-center justify-content-center">
                                    <i class="fa fa-house text-dark text-sm"></i>
                                </div>
                                <span class="nav-link-text ms-1">Swap Stations</span>
                            </a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link" href="/dashboard/vehicles.php">
                                <div class="icon icon-shape icon-sm text-center  me-2 d-flex align-items-center justify-content-center">
                                    <i class="fa fa-motorcycle text-dark text-sm"></i>
                                </div>
                        ...
                        <?php
                        if (!isset($_SESSION['email']) || $_SESSION['email'] == "mariariaemmanuel@gmail.com") {
                        ?>

                            <li class="nav-item">
                                <a class="nav-link" href="/dashboard/template.php">
                                    <div class="icon icon-shape icon-sm text-center  me-2 d-flex align-items-center justify-content-center">
                                        <i class="fa fa-file text-dark text-sm"></i>
                                    </div>
            ...
            ?>
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="/dashboard/institutions.php">
                                <div class="icon icon-shape icon-sm text-center  me-2 d-flex align-items-center justify-content-center">
                                    <i class="fa fa-building-columns text-dark text-sm"></i>
                                </div>
                                <span class="nav-link-text ms-1">All Institutions</span>
                            </a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link" href="/dashboard/financiers.php">
                                <div class="icon icon-shape icon-sm text-center  me-2 d-flex align-items-center justify-content-center">
                                    <i class="fa fa-money-check-dollar text-dark text-sm"></i>
                                </div>
                                <span class="nav-link-text ms-1">Financiers</span>
                            </a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link" href="/dashboard/hubs.php">
                                <div class="icon icon-shape icon-sm text-center  me-2 d-flex align-items-center justify-content-center">
                                    <i class="fa fa-store text-dark text-sm"></i>
                                </div>
                                <span class="nav-link-text ms-1">Hubs</span>
                            </a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link" href="/dashboard/distributors.php">
                                <div class="icon icon-shape icon-sm text-center  me-2 d-flex align-items-center justify-content-center">
                                    <i class="fa fa-truck text-dark text-sm"></i>
                                </div>
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="/dashboard/distributor outlets.php">
                                <div class="icon icon-shape icon-sm text-center  me-2 d-flex align-items-center justify-content-center">
                                    <i class="fa fa-truck text-dark text-sm"></i>
                                </div>
                                <span class="nav-link-text ms-1">Distributor Outlets</span>
                            </a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link" href="/dashboard/agents.php">
                                <div class="icon icon-shape icon-sm text-center  me-2 d-flex align-items-center justify-content-center">
                                    <i class="fa fa-people-roof text-dark text-sm"></i>
                                </div>
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="/dashboard/mechanics.php">
                                <div class="icon icon-shape icon-sm text-center  me-2 d-flex align-items-center justify-content-center">
                                    <i class="fa fa-wrench text-dark text-sm"></i>
                                </div>
            ...
            <li class="nav-item">
                <a class="nav-link" href="/dashboard/index.php">
                    <div class="icon icon-shape icon-sm text-center  me-2 d-flex align-items-center justify-content-center">
                        <i class="fa fa-address-card text-dark text-sm"></i>
                    </div>
            ...
            <li class="nav-item">
                <a class="nav-link" href="/dashboard/index.php">
                    <div class="icon icon-shape icon-sm text-center  me-2 d-flex align-items-center justify-content-center">
                        <i class="fa fa-address-book text-dark text-sm"></i>
                    </div>
            ...
            <li class="nav-item">
                <a class="nav-link" href="/dashboard/index.php">
                    <div class="icon icon-shape icon-sm text-center  me-2 d-flex align-items-center justify-content-center">
                        <i class="fa fa-circle-info text-dark text-sm"></i>
                    </div>
