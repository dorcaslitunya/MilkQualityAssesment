<div>
    <div id="DivGaugeChartturbidity" style="text-align: center">Turbidity chart here</div>
</div>
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        const chart_canvasA = document.getElementById('DivGaugeChartturbidity');
