<div>
    <div id="DivGaugeChartTemp" style="text-align: center">gauge chart here</div>
</div>
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        const chart_canvasA = document.getElementById('DivGaugeChartTemp');
